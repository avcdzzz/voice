...
const DEEPGRAM_VOICES = [
  ...
  // ── Male AI Voices ──
  { key: 'aura-2-odysseus-en', label: 'Odysseus (Aura 2)', desc: 'Calm, smooth, professional', gender: 'm', accent: 'us', emoji: '⚓', type: 'ai' },
  { key: 'aura-2-apollo-en',   label: 'Apollo (Aura 2)',   desc: 'Confident, comfortable',    gender: 'm', accent: 'us', emoji: '☀️', type: 'ai' },
  { key: 'aura-2-arcas-en',    label: 'Arcas (Aura 2)',    desc: 'Natural, smooth, clear',    gender: 'm', accent: 'us', emoji: '🎙️', type: 'ai' },
  { key: 'aura-2-aries-en',    label: 'Aries (Aura 2)',    desc: 'Warm, energetic, caring',   gender: 'm', accent: 'us', emoji: '♈', type: 'ai' },
  { key: 'aura-2-atlas-en',    label: 'Atlas (Aura 2)',    desc: 'Enthusiastic, confident',   gender: 'm', accent: 'us', emoji: '🌍', type: 'ai' },
  { key: 'aura-2-draco-en',    label: 'Draco (Aura 2)',    desc: 'Warm, trustworthy baritone',gender: 'm', accent: 'uk', emoji: '🐉', type: 'ai' },
  { key: 'aura-2-hermes-en',   label: 'Hermes (Aura 2)',   desc: 'Expressive, engaging',      gender: 'm', accent: 'us', emoji: '⚡', type: 'ai' },
  { key: 'aura-2-hyperion-en', label: 'Hyperion (Aura 2)', desc: 'Caring, warm, empathetic',  gender: 'm', accent: 'us', emoji: '🦘', type: 'ai' },
  { key: 'aura-2-jupiter-en',  label: 'Jupiter (Aura 2)',  desc: 'Knowledgeable baritone',    gender: 'm', accent: 'us', emoji: '🪐', type: 'ai' },
  { key: 'aura-2-mars-en',     label: 'Mars (Aura 2)',     desc: 'Smooth, patient baritone',  gender: 'm', accent: 'us', emoji: '🔴', type: 'ai' },
  { key: 'aura-2-neptune-en',  label: 'Neptune (Aura 2)',  desc: 'Professional, patient',     gender: 'm', accent: 'us', emoji: '🌊', type: 'ai' },
  { key: 'aura-2-orion-en',    label: 'Orion (Aura 2)',    desc: 'Approachable, calm, polite',gender: 'm', accent: 'us', emoji: '🌌', type: 'ai' },
  { key: 'aura-2-orpheus-en',  label: 'Orpheus (Aura 2)',  desc: 'Clear, confident',          gender: 'm', accent: 'us', emoji: '🎭', type: 'ai' },
  { key: 'aura-2-perseus-en',  label: 'Perseus (Aura 2)',  desc: 'Dynamic & engaging',      gender: 'm', accent: 'us', emoji: '⚔️', type: 'ai' },
  { key: 'aura-2-pluto-en',    label: 'Pluto (Aura 2)',    desc: 'Smooth, calm baritone',     gender: 'm', accent: 'us', emoji: '🖤', type: 'ai' },
  { key: 'aura-2-saturn-en',   label: 'Saturn (Aura 2)',   desc: 'Knowledgeable baritone',    gender: 'm', accent: 'us', emoji: '🪐', type: 'ai' },
  { key: 'aura-2-zeus-en',     label: 'Zeus (Aura 2)',     desc: 'Deep, trustworthy, smooth', gender: 'm', accent: 'us', emoji: '⚡', type: 'ai' },
